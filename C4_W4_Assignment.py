...
# ## Table of Contents
# - [1 - Exploring the MultiWoz Dataset](#1)
# 	- [Exercise 1 - get_conversation (UNQ_C1)](#ex-1)
# - [2 - Processing the Data for Reformer Inputs](#2)
#     - [2.1 - Tokenizing, Batching with Bucketing](#2-1)
# - [3 - Reversible Layers](#3)
# 	- [Exercise 2 - reversible_layer_forward (UNQ_C2)](#ex-2)
# 	- [Exercise 3 - reversible_layer_reverse (UNQ_C3)](#ex-3)
#     - [3.1 - Reversible Layers and Randomness](#3-1)
# - [4 - ReformerLM Training](#4)
# 	- [Exercise 4 - ReformerLM (UNQ_C4)](#ex-4)
# 	- [Exercise 5 - training_loop (UNQ_C5)](#ex-5)
# - [5 - Decode from a Pretrained Model](#5)
# 	- [Exercise 6 - ReformerLM_output_gen (UNQ_C6)](#ex-6)
# 
...
# 
# <a name="ex-2"></a>
# ### Exercise 2 - reversible_layer_forward
...
# <a name="ex-3"></a>
# ### Exercise 3 - reversible_layer_reverse
# 
...
# <a name="ex-6"></a>
# ### Exercise 6 - ReformerLM_output_gen
